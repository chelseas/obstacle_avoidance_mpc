...
if __name__ == "__main__":
    ...
    generate_quad_data(int(1e8), data_path)
    extended_suffix = suffix + "_1en10reg"
    model_save_path = "mpc/tests/data/quad_policy_"+extended_suffix
    ...
    simulate_and_plot(policy, savename="nn_policy_"+extended_suffix+".png", n_steps=20)
